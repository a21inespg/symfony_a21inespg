...
class FrameworkConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     * @default {"enabled":false,"collect":true,"collect_parameter":null,"only_exceptions":false,"only_main_requests":false,"dsn":"file:%kernel.cache_dir%\/profiler"}
    */
    ...
    */
    public function semaphore(array $value = []): \Symfony\Config\Framework\SemaphoreConfig
    {
    ...
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('semaphore', $value)) {
            $this->_usedProperties['semaphore'] = true;
            $this->semaphore = new \Symfony\Config\Framework\SemaphoreConfig($value['semaphore']);
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['semaphore'])) {
            $output['semaphore'] = $this->semaphore->toArray();
        }
