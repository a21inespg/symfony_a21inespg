...
class SanitizerConfig 
{
    ...
    private $allowAllStaticElements;
     ...
     * @return $this
     */
    public function allowAllStaticElements($value): static
    {
        $this->_usedProperties['allowAllStaticElements'] = true;
        $this->allowAllStaticElements = $value;
     ...
     * @return $this
     */
    public function blockElements(ParamConfigurator|array $value): static
    {
     ...
     * @return $this
     */
    public function dropElements(ParamConfigurator|array $value): static
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('allow_all_static_elements', $value)) {
            $this->_usedProperties['allowAllStaticElements'] = true;
            $this->allowAllStaticElements = $value['allow_all_static_elements'];
            unset($value['allow_all_static_elements']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['allowAllStaticElements'])) {
            $output['allow_all_static_elements'] = $this->allowAllStaticElements;
        }
