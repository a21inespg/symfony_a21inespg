...
class __TwigTemplate_549314c2319c539e8dd7f6bdbabbb448 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row mt-5\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["track"]) {
            ...
            echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension']->renderStimulusController($this->env, "song-controls", ["infoUrl" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("api_songs_get_one", ["id" => twig_get_attribute($this->env, $this->source,             // line 39
$context["loop"], "index", [], "any", false, false, false, 39)])]);
            ...
            echo ">
                <div class=\"d-flex mb-3\">
                    <a href=\"#\" ";
            // line 42
            echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension']->renderStimulusAction($this->env, "song-controls", "play");
            echo ">
            ...
            echo " - ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["track"], "artist", [], "any", false, false, false, 45), "html", null, true);
            echo "</span>
                    <a href=\"#\">
...
";
    ...
    {
        return array (  152 => 55,  126 => 45,  120 => 42,  116 => 40,  114 => 39,  112 => 38,  95 => 37,  62 => 7,  59 => 6,  55 => 5,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "vinyl/homepage.html.twig", "/home/uadmin/proxecto2/templates/vinyl/homepage.html.twig");
    }
}
