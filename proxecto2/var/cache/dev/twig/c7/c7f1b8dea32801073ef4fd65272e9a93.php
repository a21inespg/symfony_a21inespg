...
class __TwigTemplate_6a3437b5aad435f891ec3ada23437167 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["mix"]) {
            ...
            echo "</span>
                    <span>";
            // line 37
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["mix"], "createdAt", [], "any", false, false, false, 37), "Y-m-d"), "html", null, true);
            echo "</span>
                </div>
            </div>
            ";
...
";
    ...
    {
        return array (  136 => 41,  126 => 37,  122 => 36,  117 => 34,  113 => 33,  108 => 30,  104 => 29,  95 => 22,  93 => 20,  88 => 17,  86 => 15,  81 => 12,  79 => 10,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}
", "vinyl/browse.html.twig", "/home/uadmin/proxecto2/templates/vinyl/browse.html.twig");
    }
}
